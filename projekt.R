...
kobiety <- filter(dane, dane$gender == "female")
mezczyzni <- filter(dane, dane$gender == "male")
summary(kobiety$average.score)
summary(mezczyzni$average.score)
